...
#include "utan.tbl"
  ...
  if (w<=g3.d) {
    ...
    t3 = (t2<ZERO) ? -t2 : t2;
    t4=fi*ua3.d+t3*ub3.d;  if ((y=fi+(t2-t4))==fi+(t2+t4))  return (s*y);
  ...
  if (w<=g4.d) {
    ...
    if (n) {
      ...
      t3 = (t2<ZERO) ? -t2 : t2;
      t4=gi*ua10.d+t3*ub10.d;  if ((y=gi-(t2-t4))==gi-(t2+t4))  return (-sy*y); }
    else   {
      /* tan */
      t2 = pz*(gi+fi)/(gi-pz);
      if ((y=fi+(t2-fi*u9.d))==fi+(t2+fi*u9.d))  return (sy*y);
      t3 = (t2<ZERO) ? -t2 : t2;
      t4=fi*ua9.d+t3*ub9.d;  if ((y=fi+(t2-t4))==fi+(t2+t4))  return (sy*y); }
  ...
  if (w<=g5.d) {
    ...
    if (n) {
      ...
      t3 = (t2<ZERO) ? -t2 : t2;
      t4=gi*ua18.d+t3*ub18.d;  if ((y=gi-(t2-t4))==gi-(t2+t4))  return (-sy*y); }
    else   {
      /* tan */
      t2 = pz*(gi+fi)/(gi-pz);
      if ((y=fi+(t2-fi*u17.d))==fi+(t2+fi*u17.d))  return (sy*y);
      t3 = (t2<ZERO) ? -t2 : t2;
      t4=fi*ua17.d+t3*ub17.d;  if ((y=fi+(t2-t4))==fi+(t2+t4))  return (sy*y); }
  ...
  if (n) {
    ...
    t3 = (t2<ZERO) ? -t2 : t2;
    t4=gi*ua26.d+t3*ub26.d;  if ((y=gi-(t2-t4))==gi-(t2+t4))  return (-sy*y); }
  else   {
    /* tan */
    t2 = pz*(gi+fi)/(gi-pz);
    if ((y=fi+(t2-fi*u25.d))==fi+(t2+fi*u25.d))  return (sy*y);
    t3 = (t2<ZERO) ? -t2 : t2;
    t4=fi*ua25.d+t3*ub25.d;  if ((y=fi+(t2-t4))==fi+(t2+t4))  return (sy*y); }
